...
def startGame():
    ...
    bg = pygame.image.load('src/pictures/starbg.png')
    alienImg = pygame.image.load('src/pictures/alienShip.png')
    playerRocket = pygame.image.load('src/pictures/spaceRocket.png')
    star = pygame.image.load('src/pictures/star.png')
    asteroid50 = pygame.image.load('src/pictures/asteroid50.png')
    asteroid100 = pygame.image.load('src/pictures/asteroid100.png')
    asteroid150 = pygame.image.load('src/pictures/asteroid150.png')

    shoot = pygame.mixer.Sound('src/sounds/shoot.wav')
    bangLargeSound = pygame.mixer.Sound('src/sounds/bangLarge.wav')
    bangSmallSound = pygame.mixer.Sound('src/sounds/bangSmall.wav')
